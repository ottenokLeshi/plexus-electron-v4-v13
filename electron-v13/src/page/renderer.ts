...
const initPlexus = (globalObj: any) => {
    const plexusConnectionDetails = globalObj.plexusConnectionDetails;
    ...
    globalObj.plexus = globalObj.plexus || {};
    globalObj.plexus.getConnectionDetails = () => plexusConnectionDetails
}
